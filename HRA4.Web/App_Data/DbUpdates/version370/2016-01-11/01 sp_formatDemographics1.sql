...
VALUES (GETDATE(),'2016-01-11',N'01 sp_formatDemographics1')
GO
--end HRA script header--
/****** Object:  StoredProcedure [dbo].[sp_formatDemographics1]    Script Date: 01/11/2016 09:09:09 ******/
...
BEGIN
	...
	SELECT @value = BMI, @displayValue=BMICategory  FROM tblRiskDataExt2 WHERE apptID = @apptID
	IF (@value IS NOT NULL)
	BEGIN
		IF(LEN(@value) > 0)
		BEGIN

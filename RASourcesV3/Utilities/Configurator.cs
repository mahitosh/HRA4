...
namespace RiskApps3.Utilities
{
    public class Configurator
    {
        ...
        public static NameValueCollection GetConfig(string section)
        {
            ...
            //Silicus: Start[Changes to make the class behave non singleton and use configuration as per seleted Institution]
            ...
            } //Silicus:End[Changes to make the class behave non singleton and use configuration as per seleted Institution]

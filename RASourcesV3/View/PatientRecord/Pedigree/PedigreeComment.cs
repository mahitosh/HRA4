...
namespace RiskApps3.View.PatientRecord.Pedigree
{
    public partial class PedigreeComment : PedigreeComponent
    {
        ...
        internal int ComputeOptimalHeight(int usableWidth)
        {
            this.Width = usableWidth;
            this.commentsTextBox.Width = usableWidth;

            int height = (int)this.commentsTextBox.CreateGraphics().MeasureString(this.commentsTextBox.Text, this.commentsTextBox.Font, usableWidth).Height;
            return height;
        }
    }
}

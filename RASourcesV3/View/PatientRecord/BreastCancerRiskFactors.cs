...
namespace RiskApps3.View.PatientRecord
{
    public partial class BreastCancerRiskFactors : HraView
    {
        ...
        {
            estrogenYears.Items.Clear();
            premarinYears.Items.Clear();
            proveraYears.Items.Clear();
            tamoxifenYears.Items.Clear();
            otherHormonesYears.Items.Clear();

            estrogenYears.Items.Add("");
            premarinYears.Items.Add("");
            proveraYears.Items.Add("");
            tamoxifenYears.Items.Add("");
            otherHormonesYears.Items.Add("");
            for (int i = 1; i <= 50; i++)
            {
                estrogenYears.Items.Add("" + i);
                premarinYears.Items.Add("" + i);
                proveraYears.Items.Add("" + i);
                tamoxifenYears.Items.Add("" + i);
                otherHormonesYears.Items.Add("" + i);
            }
        }
        ...
        private void FillPhysicalExamControls()
        {
            ...
            BMI.Text = physicalExam.PhysicalExamination_BMI;

            weightChangeLastMammo.Text = physicalExam.PhysicalExamination_weightChangeLastMammo;
        ...
        private void FillObGynHxControls()
        {
            ...
            nursingPast3Months.Text = obGynHx.ObGynHistory_nursingPast3Months;
            ...
            takenFertilityDrugs.Text = obGynHx.ObGynHistory_takenFertilityDrugs;
            ...
            estrogenYesNo.Checked = (obGynHx.ObGynHistory_estrogenYesNo == null ? false : obGynHx.ObGynHistory_estrogenYesNo.Equals(Yes));
            premarinYesNo.Checked = (obGynHx.ObGynHistory_premarinYesNo == null ? false : obGynHx.ObGynHistory_premarinYesNo.Equals(Yes));
            proveraYesNo.Checked = (obGynHx.ObGynHistory_proveraYesNo == null ? false : obGynHx.ObGynHistory_proveraYesNo.Equals(Yes));
            tamoxifenYesNo.Checked = (obGynHx.ObGynHistory_tamoxifenYesNo == null ? false : obGynHx.ObGynHistory_tamoxifenYesNo.Equals(Yes));
            otherHormonesYesNo.Checked = (obGynHx.ObGynHistory_otherHormonesYesNo == null ? false : obGynHx.ObGynHistory_otherHormonesYesNo.Equals(Yes));

            estrogenYears.Text = obGynHx.ObGynHistory_estrogenYears;
            premarinYears.Text = obGynHx.ObGynHistory_premarinYears;
            proveraYears.Text = obGynHx.ObGynHistory_proveraYears;
            tamoxifenYears.Text = obGynHx.ObGynHistory_tamoxifenYears;
            otherHormonesYears.Text = obGynHx.ObGynHistory_otherHormonesYears;

            estrogenStillUsing.Text = obGynHx.ObGynHistory_estrogenStillUsing;
            premarinStillUsing.Text = obGynHx.ObGynHistory_premarinStillUsing;
            proveraStillUsing.Text = obGynHx.ObGynHistory_proveraStillUsing;
            tamoxifenStillUsing.Text = obGynHx.ObGynHistory_tamoxifenStillUsing;
            otherHormonesStillUsing.Text = obGynHx.ObGynHistory_otherHormonesStillUsing;

            otherHormonesExplain.Text = obGynHx.ObGynHistory_otherHormonesExplain;
            ToggleEnabledFields();
        }
        ...
        {
            estrogenYears.Enabled = (estrogenYesNo.Checked);
            estrogenStillUsing.Enabled = (estrogenYesNo.Checked);

            premarinYears.Enabled = (premarinYesNo.Checked);
            premarinStillUsing.Enabled = (premarinYesNo.Checked);

            proveraYears.Enabled = (proveraYesNo.Checked);
            proveraStillUsing.Enabled = (proveraYesNo.Checked);

            tamoxifenYears.Enabled = (tamoxifenYesNo.Checked);
            tamoxifenStillUsing.Enabled = (tamoxifenYesNo.Checked);

            otherHormonesYears.Enabled = (otherHormonesYesNo.Checked);
            otherHormonesStillUsing.Enabled = (otherHormonesYesNo.Checked);
            otherHormonesExplain.Enabled = (otherHormonesYesNo.Checked);

            if (!estrogenYesNo.Checked){
               estrogenYears.Text = "";
               estrogenStillUsing.Text = "";
            }

            if (!premarinYesNo.Checked)
            {
                premarinYears.Text = "";
                premarinStillUsing.Text = "";
            }

            if (!proveraYesNo.Checked)
            {
                proveraYears.Text = "";
                proveraStillUsing.Text = "";
            }

            if (!tamoxifenYesNo.Checked)
            {
                tamoxifenYears.Text = "";
                tamoxifenStillUsing.Text = "";
            }

            if (!otherHormonesYesNo.Checked)
            {
                otherHormonesYears.Text = "";
                otherHormonesStillUsing.Text = "";
                otherHormonesExplain.Text = "";
            }
        ...
        private void BreastCancerRiskFactors_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (this.obGynHx != null)
                this.obGynHx.ReleaseListeners(this);


            if (!estrogenYesNo.Checked)
            {
                obGynHx.ObGynHistory_estrogenYears = "";
                obGynHx.ObGynHistory_estrogenStillUsing = "";
            }

            if (!premarinYesNo.Checked)
            {
                obGynHx.ObGynHistory_premarinYears = "";
                obGynHx.ObGynHistory_premarinStillUsing = "";
            }

            if (!proveraYesNo.Checked)
            {
                obGynHx.ObGynHistory_proveraYears = "";
                obGynHx.ObGynHistory_proveraStillUsing = "";
            }

            if (!tamoxifenYesNo.Checked)
            {
                obGynHx.ObGynHistory_tamoxifenYears = "";
                obGynHx.ObGynHistory_tamoxifenStillUsing = "";
            }

            if (!otherHormonesYesNo.Checked)
            {
                obGynHx.ObGynHistory_otherHormonesYears = "";
                obGynHx.ObGynHistory_otherHormonesStillUsing = "";
                obGynHx.ObGynHistory_otherHormonesExplain = "";
            }
        ...
        private void weightChangeLastMammo_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (!ViewClosing)
                physicalExam.PhysicalExamination_weightChangeLastMammo = weightChangeLastMammo.Text;
        }

        private void takenFertilityDrugs_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (!ViewClosing)
                obGynHx.ObGynHistory_takenFertilityDrugs = takenFertilityDrugs.Text;
        }

        private void nursingPast3Months_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (!ViewClosing)
                obGynHx.ObGynHistory_nursingPast3Months = nursingPast3Months.Text;
            
        }


        private void estrogenYesNo_CheckStateChanged(object sender, EventArgs e)
        {
            if (!ViewClosing)
            {
                if (estrogenYesNo.Checked)
                {
                    obGynHx.ObGynHistory_estrogenYesNo = "Yes";
                }
                else
                {
                    obGynHx.ObGynHistory_estrogenYesNo = "No";
                }
                ToggleEnabledFields();
            }
        }

        private void premarinYesNo_CheckStateChanged(object sender, EventArgs e)
        {
            if (!ViewClosing)
            {
                if (premarinYesNo.Checked)
                {
                    obGynHx.ObGynHistory_premarinYesNo = "Yes";
                }
                else
                {
                    obGynHx.ObGynHistory_premarinYesNo = "No";
                }
                ToggleEnabledFields();
            }
        }

        private void proveraYesNo_CheckStateChanged(object sender, EventArgs e)
        {
            if (!ViewClosing)
            {
                if (proveraYesNo.Checked)
                {
                    obGynHx.ObGynHistory_proveraYesNo = "Yes";
                }
                else
                {
                    obGynHx.ObGynHistory_proveraYesNo = "No";
                }
                ToggleEnabledFields();
            }
        }

        private void tamoxifenYesNo_CheckStateChanged(object sender, EventArgs e)
        {
            if (!ViewClosing)
            {
                if (tamoxifenYesNo.Checked)
                {
                    obGynHx.ObGynHistory_tamoxifenYesNo = "Yes";
                }
                else
                {
                    obGynHx.ObGynHistory_tamoxifenYesNo = "No";
                }
                ToggleEnabledFields();
            }
        }

        private void otherHormonesYesNo_CheckStateChanged(object sender, EventArgs e)
        {
            if (!ViewClosing)
            {
                if (otherHormonesYesNo.Checked)
                {
                    obGynHx.ObGynHistory_otherHormonesYesNo = "Yes";
                }
                else
                {
                    obGynHx.ObGynHistory_otherHormonesYesNo = "No";
                }
                ToggleEnabledFields();
            }
        }

        private void estrogenYears_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (!ViewClosing)
                obGynHx.ObGynHistory_estrogenYears = estrogenYears.Text;
        }

        private void premarinYears_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (!ViewClosing)
                obGynHx.ObGynHistory_premarinYears = premarinYears.Text;
        }

        private void proveraYears_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (!ViewClosing)
                obGynHx.ObGynHistory_proveraYears = proveraYears.Text;
        }

        private void tamoxifenYears_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (!ViewClosing)
                obGynHx.ObGynHistory_tamoxifenYears = tamoxifenYears.Text;
        }

        private void otherHormonesYears_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (!ViewClosing)
                obGynHx.ObGynHistory_otherHormonesYears = otherHormonesYears.Text;
        }

        private void estrogenStillUsing_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (!ViewClosing)
                obGynHx.ObGynHistory_estrogenStillUsing = estrogenStillUsing.Text;
        }

        private void premarinStillUsing_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (!ViewClosing)
                obGynHx.ObGynHistory_premarinStillUsing = premarinStillUsing.Text;
        }

        private void proveraStillUsing_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (!ViewClosing)
                obGynHx.ObGynHistory_proveraStillUsing = proveraStillUsing.Text;
        }

        private void tamoxifenStillUsing_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (!ViewClosing)
                obGynHx.ObGynHistory_tamoxifenStillUsing = tamoxifenStillUsing.Text;
        }

        private void otherHormonesStillUsing_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (!ViewClosing)
                obGynHx.ObGynHistory_otherHormonesStillUsing = otherHormonesStillUsing.Text;
        }

        private void otherHormonesExplain_Validated(object sender, EventArgs e)
        {
            if (!ViewClosing)
                obGynHx.ObGynHistory_otherHormonesExplain = otherHormonesExplain.Text;
        }

        private void biopsyLCIS_SelectedIndexChanged(object sender, EventArgs e)
        {

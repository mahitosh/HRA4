...
namespace RiskApps3.View.BreastImaging
{
    ...
    {
        private readonly AddEditCopyApptController _addEditCopyApptController;
        ...
        {
            this._addEditCopyApptController = new AddEditCopyApptController(this);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (fastDataListView1.SelectedObject != null)
            {
                    ...
                    DialogResult.Yes)
                {
                    ...
                    pc.Add("applicationID", "RiskApps3 - BreastImagingDashboard");
        ...
        private void addApptButton_Click(object sender, EventArgs e)
        {
            ...
            this._addEditCopyApptController.AddAppt(clinicId);
        ...
        private void editApptButton_Click(object sender, EventArgs e)
        {
            if (fastDataListView1.SelectedObject != null)
            {
                ...
                this._addEditCopyApptController.EditAppt(clinicId, selectedAppt);
                
                GetNewAppointmentList();
            }
            else
            {
                this._addEditCopyApptController.ShowNoAppointmentSelectedErrorMessage();
            }
        }
        ...
        private void copyApptButton_Click(object sender, EventArgs e)
        {
            if (fastDataListView1.SelectedObject != null)
            {
                ...
                this._addEditCopyApptController.CopyAppt(clinicId, selectedAppt);

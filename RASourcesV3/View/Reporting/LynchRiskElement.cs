...
{
    public partial class LynchRiskElement : UserControl
    {
        ...
        public LynchRiskElement(DateTime StartTime, DateTime EndTime, int clinicId)
        {
            highrisk.type = "Lynch";
        ...
        private void LoadChart()
        {
            ...
            high.Name = "High Lynch Mutation Risk";

...
namespace RiskApps3.View.Common.AutoSearchTextBox
{
    ...
    {
        [Browsable(true)]
        public event EventHandler CoolTextChanged;

        private void HandleTextChanged(object sender, EventArgs e)
        {
            this.OnCoolTextChanged(e);
        }

        protected virtual void OnCoolTextChanged(EventArgs e)
        {
            EventHandler handler = this.CoolTextChanged;
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        public object Value
        {
            get { return this.autoCompleteTextBox1.Value; }
            set { this.autoCompleteTextBox1.Value = value; }
        }
        ...
        public CoolTextBox() {
            ...
            this.autoCompleteTextBox1.TextChanged += this.HandleTextChanged;
        }

...
namespace RiskApps3.View.Common.AutoSearchTextBox
{
    ...
    public class AutoCompleteTextBox : TextBox {
        ...
        protected virtual void SelectCurrentItem() {
            ...
            Value = SetValue(list.SelectedItem);
            if (Text.Length > 0) {
        ...
        private object SetValue(object selectedItem)
        {
            AutoCompleteEntry item = selectedItem as AutoCompleteEntry;
            if (item != null)
            {
                return item.Value;
            }
        ...
        protected virtual AutoCompleteEntryCollection FilterList(AutoCompleteEntryCollection list) {
            ...
            try
            {
                foreach (IAutoCompleteEntry entry in list)
                {
                    ...
                    {
                        //TODO consider using a hash value rather than a string comparison to compare matches

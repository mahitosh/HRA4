...
namespace RiskApps3.Model.PatientRecord
{
    ...
    public class RiskProfile : HraObject
    {
        ...
        [DataMember] [HraAttribute] public double? TyrerCuzick_Brca_1;  // jdg 11/17/15
        [DataMember] [HraAttribute] public double? TyrerCuzick_Brca_2;  // jdg 11/17/15
        ...
        [DataMember] [HraAttribute] public double? TyrerCuzick_5Year_populationRisk;    // jdg 11/17/15
        [DataMember] [HraAttribute] public double? TyrerCuzick_Lifetime_populationRisk; // jdg 11/17/15

        [DataMember] [HraAttribute] public double? TyrerCuzick_v7_Brca_1_2;
        [DataMember] [HraAttribute] public double? TyrerCuzick_v7_Brca_1;   // jdg 11/17/15
        [DataMember] [HraAttribute] public double? TyrerCuzick_v7_Brca_2;   // jdg 11/17/15
        ...
        [DataMember] [HraAttribute] public double? TyrerCuzick_v7_5Year_populationRisk;    // jdg 11/17/15
        [DataMember] [HraAttribute] public double? TyrerCuzick_v7_Lifetime_populationRisk; // jdg 11/17/15
        ...
        [DataMember] [HraAttribute] public string riskCode; // jdg 11/17/15
        [DataMember] [HraAttribute] public string riskText; // jdg 11/17/15
        [DataMember] [HraAttribute] public string riskFormattedText; // jdg 11/17/15
        ...
        /*****************************************************/
        public string RiskProfile_riskCode
        {
            get
            {
                return riskCode;
            ...
            set
            {
                if (value != riskCode)
                {
                    riskCode = value;
                    HraModelChangedEventArgs args = new HraModelChangedEventArgs(null);
                    args.updatedMembers.Add(GetMemberByName("riskCode"));
                    SignalModelChanged(args);
                }
            }
        }
        /*****************************************************/
        public string RiskProfile_riskText
        {
            get
            {
                return riskText;
            ...
            set
            {
                if (value != riskText)
                {
                    riskText = value;
                    HraModelChangedEventArgs args = new HraModelChangedEventArgs(null);
                    args.updatedMembers.Add(GetMemberByName("riskText"));
                    SignalModelChanged(args);
                }
            }
        }
        /*****************************************************/
        public string RiskProfile_riskFormattedText
        {
            get
            {
                return riskFormattedText;
            }
            set
            {
                if (value != riskFormattedText)
                {
                    riskFormattedText = value;
                    HraModelChangedEventArgs args = new HraModelChangedEventArgs(null);
                    args.updatedMembers.Add(GetMemberByName("riskFormattedText"));
                    SignalModelChanged(args);
                }
            }
        } 
        ...
        public override void BackgroundLoadWork()
        {
            ...
            TyrerCuzick_Brca_1 = null;  // jdg 11/17/15
            TyrerCuzick_Brca_2 = null;  // jdg 11/17/15
            TyrerCuzick_5Year_Breast = null;
            TyrerCuzick_Lifetime_Breast = null;
            TyrerCuzick_5Year_populationRisk = null;    // jdg 11/17/15
            TyrerCuzick_Lifetime_populationRisk = null; // jdg 11/17/15
            TyrerCuzick_v7_Brca_1_2 = null;
            TyrerCuzick_v7_Brca_1 = null;   // jdg 11/17/15
            TyrerCuzick_v7_Brca_2 = null;   // jdg 11/17/15
            TyrerCuzick_v7_5Year_Breast = null;
            TyrerCuzick_v7_Lifetime_Breast = null;
            TyrerCuzick_v7_5Year_populationRisk = null;    // jdg 11/17/15
            TyrerCuzick_v7_Lifetime_populationRisk = null; // jdg 11/17/15
            Claus_5Year_Breast = null;
            Claus_Lifetime_Breast = null;
            Gail_5Year_Breast = null;
            Gail_Lifetime_Breast = null;
            riskCode = "";              // jdg 11/17/15
            riskText = "";              // jdg 11/17/15
            riskFormattedText = "";     // jdg 11/17/15

...
namespace RiskApps3.Model.PatientRecord
{
    ...
    public class Person : HraObject
    {
        ...
        public string Person_educationLevel
        {
            get { return this.educationLevel; }
            set
            {
                this.educationLevel = value;
                this.SignalMemberChanged(GetMemberByName("educationLevel"));
            }
        }
        ...
        public string Person_gender
        {
            ...
            set
            {
                value = Gender.ToString(Gender.Parse(value));
                if (value != gender)
                {
                    gender = value;
                    HraModelChangedEventArgs args = new HraModelChangedEventArgs(null);

...
namespace RiskApps3.Model.Session
{
    ...
    internal class Lookups : HraObject, IDictionary<string, List<string>>
    {
        ...
        public override void BackgroundLoadWork()
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(BCDB2.Instance.getConnectionString()))
                {
                    ...
                    {
                        SqlCommand cmdProcedure = BuildCmdProcedure(connection, table);
        ...
        private SqlCommand BuildCmdProcedure(SqlConnection connection, string table)
        {
            ...
            cmdProcedure.Parameters.Add(TableParamName, SqlDbType.NVarChar).Value = table;
            return cmdProcedure;
        }

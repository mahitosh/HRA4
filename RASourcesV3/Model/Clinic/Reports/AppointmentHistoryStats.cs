...
{
    public class AppointmentHistoryStats : HRAList<AppointmentHistoryStats.AppointmentStat>
    {
    ...
    public class AppointmentHistorySummaryStats : HRAList<AppointmentHistorySummaryStats.AppointmentSummaryStat>
    {
        private object[] construction_args;
        private ParameterCollection pc;

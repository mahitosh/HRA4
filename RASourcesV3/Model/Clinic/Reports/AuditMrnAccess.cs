...
{
    public class AuditMrnAccessV2 : HRAList<AuditMrnAccessV2Entry> //Silicus: Set the class as public
    {
    ...
    public class AuditMrnAccessV3 : HRAList<AuditMrnAccessV3Entry> // Silicus
    {
        public DateTime StartTime;
        public DateTime EndTime;
        public string unitnum;
    ...
    class MrnList : HRAList<MrnListEntry>
    {
        private object[] construction_args;
        private ParameterCollection pc;

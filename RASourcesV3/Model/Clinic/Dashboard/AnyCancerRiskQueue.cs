...
{
    public class AnyCancerRiskQueue : Queue
    {
        public int clinicId = -1;

        public AnyCancerRiskQueue()
        {
        ...
        public override void BackgroundLoadWork()
        {
            ...
            dt = new DataTable();
            SqlDataReader dr = BCDB2.Instance.ExecuteReaderSPWithParams("sp_3_LoadAnyCancerRiskQueue", pc);
            dt.Load(dr);
        }

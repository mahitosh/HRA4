...
namespace RiskApps3.View.Appointments
{
    public partial class WebAppointments : Form
    {
        ...
        private string SYNCH_APPT = "Accept - Copy Web Survey To Existing Appoinment";
        private string CREATE_NEW_APPT = "Accept - Create New Appointment for Web Survey";

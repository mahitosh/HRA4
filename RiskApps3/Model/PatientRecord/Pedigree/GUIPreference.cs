...
namespace RiskApps3.Model.PatientRecord
{
    ...
    public class GUIPreference : HraObject
    {
        ...
        [DataMember] [HraAttribute (auditable=false)] protected int pedigreeZoomValue = 100;
        ...
        [DataMember] [HraAttribute (auditable=false)] protected int LegendY = 50;
        [DataMember] [HraAttribute (auditable=false)] protected int LegendHeight = 100;
        [DataMember] [HraAttribute (auditable=false)] protected int LegendWidth = 350;
        [DataMember] [HraAttribute (auditable=false)] protected int TitleX = 40;
        [DataMember] [HraAttribute (auditable=false)] protected int TitleY = 50;
        [DataMember] [HraAttribute (auditable=false)] protected int TitleHeight = 100;
        [DataMember] [HraAttribute (auditable=false)] protected int TitleWidth = 150;
        [DataMember] [HraAttribute (auditable=false)] protected int CommentX = 40;
        [DataMember] [HraAttribute (auditable=false)] protected int CommentY = 450;
        [DataMember] [HraAttribute (auditable=false)] protected int CommentHeight = 90;
        [DataMember] [HraAttribute (auditable=false)] protected int CommentWidth = 230;
